...
(let [corpus (an/load-data "../data/corpus.seed.edn")
      meths  (an/load-data "v1-jp-seed.edn")
  ...
  (check "tx-cid(derived-datoms, \"\") == kotoba.py golden"
         (= "b291c8ba468d44b6236fe8a73cfdbfc2df06e171ba71f17afed570c90b75e99c7"
            (ko/tx-cid dd "")))
  ...
  (let [tx (ko/make-tx dd :tx-id 1 :as-of 1000)]
    ...
    (check "make-tx :tx/cid == tx-cid golden"
           (= "b291c8ba468d44b6236fe8a73cfdbfc2df06e171ba71f17afed570c90b75e99c7" (get tx ":tx/cid"))))
